...
(function() {
    ...
    const projectsData = [
        {
          id: 18,
            "title": "Автономный ассистент 2025 для CV-разработки на Python",
          ...
          "tasks": [
            {
              "name": "Подготовка",
              "description": "Анализ существующих решений, аналогичных Cursor AI, выявление преимуществ и недостатков."
            },
            {
              "name": "Настройка и доработка",
              "description": "Настройка ассистента под конкретную аппаратную конфигурацию, проверка производительности и необходимой оптимизации."
            },
            {
              "name": "Минимально жизнеспособный продукт (MVP)",
              "description": "Достижение ключевых показателей качества и документации результатов."
            }
          ],
          ...
          "status": "completed",
          "features": [
            "Автономная работа без онлайн-зависимости",
            "Высокая производительность на GPU",
            "Оптимизация под стандартные рабочие станции",
            "Работа с большими объёмами данных",
            "Свободный интерфейс с возможностью локализации"
          ],
          "results": [
            "Полный рабочий цикл создания CV-кода",
        ...
        },
        {
            ...
            description: 'Настроить Гибридного AI-агента для CV проектов',
            fullDescription: 'Создать полностью автономный инструмент для помощи в написании кода на Python для задач технического (компьютерного) зрения, лишённый зависимости от санкционных сервисов и обеспечивающий: 1. удовлетворительную скорость работы; 2. специализацию на CV‑библиотеках; 3. простоту интеграции с рабочей средой разработчика.',
            tasks: '**Этап 1. Подготовка**: анализ готовых решений на рынке, тестирование аналогов Cursor AI в России; **Этап 2. Настройка и доработка**: 1. настройка под целевую аппаратную конфигурацию; 2. тестирование производительности; 3. оптимизация скорости работы в случае необходимости; **Этап 3. MVP**: 1. достижение ключевых показателей; 2. документирование.',
