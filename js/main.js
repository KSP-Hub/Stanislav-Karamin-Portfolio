    ...
    const projectsData = [
        {
            ...
            hours: 37,683333,
            status: 'done',
            features: ['Автономная работа без онлайн-зависимости', 'Высокая производительность на GPU', 'Оптимизация под стандартные рабочие станции', 'Работа с большими объёмами данных', 'Свободный интерфейс с возможностью локализации'],
            results: [
